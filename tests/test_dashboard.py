...
class DashboardTests(unittest.TestCase):
    ...
    def test_render_dashboard_html_shows_daily_review_block_in_daily_review_view(self) -> None:
        ...
        self.assertIn("<form class='daily-review-date-form' method='get' action='.'>", html)
        self.assertIn("<input type='hidden' name='room' value='review'>", html)
        self.assertIn("<input type='hidden' name='range' value='1D'>", html)
        self.assertIn("<input type='hidden' name='review_view' value='daily'>", html)
    ...
    def test_render_dashboard_html_includes_health_runtime_and_recent_events(self) -> None:
        ...
        self.assertLess(system_html.index("SYSTEM HEALTH"), system_html.index("Runtime DB: /tmp/runtime.db"))
        self.assertIn("RECENT EVENTS", system_html)
        self.assertIn("No recent action events", system_html)
    ...
    def test_render_dashboard_html_refocuses_overview_as_live_workbench(self) -> None:
        ...
        self.assertLess(html.index("Execution Results"), html.index("Execution Chain"))
        self.assertIn("<div class='execution-flow-row execution-flow-row-primary'>", html)
        self.assertIn("<div class='execution-flow-row execution-flow-row-support'>", html)
...
"""
    ...
    def test_render_dashboard_html_includes_positions_section(self) -> None:
        ...
        self.assertLess(system_html.index("SYSTEM DIAGNOSTICS"), system_html.index("SYSTEM HEALTH"))
        self.assertLess(system_html.index("SYSTEM HEALTH"), system_html.index("SYSTEM CONFIG"))
        self.assertLess(system_html.index("SYSTEM CONFIG"), system_html.index("RECENT EVENTS"))
    ...
    def test_render_dashboard_html_uses_two_column_live_core_lines_grid(self) -> None:
        ...
        self.assertIn("data-core-live-range", html)
        self.assertIn("core-live-range-chip active", html)
        self.assertIn("aria-pressed='true'>1D</button>", html)
    ...
    def test_render_dashboard_html_surfaces_execution_performance_and_signal_aggregates(self) -> None:
        ...
        self.assertIn("Execution Results", live_html)
        self.assertIn("Execution Chain", live_html)
        self.assertLess(live_html.index("Latest Fill"), live_html.index("Latest Broker Action"))
    ...
    def test_render_dashboard_html_prioritizes_live_overview_and_compacts_position_cards(self) -> None:
        ...
        self.assertIn("Execution Results", html)
        self.assertIn("Execution Chain", html)
        self.assertIn("execution-flow-row-primary", html)
        self.assertIn("execution-flow-row-support", html)
