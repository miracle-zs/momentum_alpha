...
"""
    ...
    def test_render_dashboard_html_uses_explicit_headers_and_trimmed_precision(self) -> None:
        ...
        self.assertIn("round-trip-leg-digest", round_trip_html)
        self.assertIn("Qty 1", round_trip_html)
        self.assertIn("Entry 10.0000", round_trip_html)
        self.assertIn("Stop 9.0000", round_trip_html)
        self.assertNotIn("Leg #", round_trip_html)
        self.assertNotIn("Stop At Entry", round_trip_html)
        self.assertNotIn("Cum Risk", round_trip_html)
        self.assertNotIn("Fee Share", round_trip_html)
        self.assertNotIn("Net Contribution", round_trip_html)
    ...
    def test_render_dashboard_html_surfaces_margin_usage_controls_and_leg_analytics(self) -> None:
        ...
        self.assertIn("round-trip-leg-digest", html)
