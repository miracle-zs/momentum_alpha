...
def _build_execution_flow_panel(
    *,
    ...
    def _execution_flow_row(*, label: str, primary: str, secondary: str, detail: str, tone: str) -> str:
        return (
            f"<div class='execution-flow-row execution-flow-row-{tone}'>"
            f"<div class='execution-flow-label'>{escape(label)}</div>"
            "<div class='execution-flow-body'>"
    ...
    broker_row = _execution_flow_row(
    ...
    stop_exit_row = _execution_flow_row(
    ...
    return (
        ...
        "<div class='execution-flow-group execution-flow-group-primary'>"
        "<div class='execution-flow-group-label'>Execution Results</div>"
        f"{fill_row}{stop_exit_row}"
        "</div>"
        "<div class='execution-flow-group execution-flow-group-secondary'>"
        "<div class='execution-flow-group-label'>Execution Chain</div>"
        f"{broker_row}{algo_row}"
        "</div>"
        "</div>"
        "</section>"
    )
