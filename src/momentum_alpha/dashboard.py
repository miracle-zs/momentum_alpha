...
def build_dashboard_summary_payload(snapshot: dict) -> dict:
    from momentum_alpha.dashboard_data import build_dashboard_summary_payload as _build_dashboard_summary_payload

    return _build_dashboard_summary_payload(snapshot)


def build_dashboard_timeseries_payload(snapshot: dict) -> dict:
    from momentum_alpha.dashboard_data import build_dashboard_timeseries_payload as _build_dashboard_timeseries_payload

    return _build_dashboard_timeseries_payload(snapshot)


def build_trade_leg_count_aggregates(round_trips: list[dict]) -> list[dict]:
    from momentum_alpha.dashboard_data import build_trade_leg_count_aggregates as _build_trade_leg_count_aggregates

    return _build_trade_leg_count_aggregates(round_trips)


def build_trade_leg_index_aggregates(round_trips: list[dict]) -> list[dict]:
    from momentum_alpha.dashboard_data import build_trade_leg_index_aggregates as _build_trade_leg_index_aggregates

    return _build_trade_leg_index_aggregates(round_trips)


def build_dashboard_tables_payload(snapshot: dict) -> dict:
    from momentum_alpha.dashboard_data import build_dashboard_tables_payload as _build_dashboard_tables_payload

    return _build_dashboard_tables_payload(snapshot)
...
def load_dashboard_snapshot(
    *,
    ...
    from momentum_alpha.dashboard_data import load_dashboard_snapshot as _load_dashboard_snapshot
...
def build_dashboard_response_json(snapshot: dict) -> str:
    from momentum_alpha.dashboard_data import build_dashboard_response_json as _build_dashboard_response_json

    return _build_dashboard_response_json(snapshot)
